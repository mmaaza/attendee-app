...
const RegistrationConfirmationPage = () => {
  ...
  const { firstName, lastName, email, attendeeId, documentId, qrCodeUrl } = location.state || {};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-100">
        <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
          <h2 className="text-2xl font-bold text-secondary-900 mb-4">Registration Information Not Found</h2>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-white rounded-2xl shadow-card border border-secondary-100 p-8 text-center">
          ...
          <p className="text-secondary-600 mb-8">
            Thank you for registering for NepDent IDS 2025. Your registration has been confirmed.
          </p>
          
          <div className="bg-secondary-50 p-6 rounded-xl mb-8">
            <div className="mb-4">
              <p className="text-sm text-secondary-500">Attendee Name</p>
              <p className="font-medium text-secondary-900">{firstName} {lastName}</p>
            </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-secondary-900 mb-4">Your Check-In QR Code</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => window.print()} className="bg-secondary-100 text-secondary-800 px-6 py-3 rounded-xl font-medium hover:bg-secondary-200 transition-colors">
              Print Details
            </button>
            <Link to="/" className="bg-primary-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-primary-700 transition-colors">
              Return to Home
            </Link>
          </div>
        </div>
        ...
        <div className="mt-8 bg-white p-5 rounded-xl shadow-sm border border-secondary-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-secondary-900 font-semibold">Important Information</h3>
              <p className="text-secondary-600 text-sm mt-1">
                You will also receive a confirmation email with these details. For any questions, please contact <span className="text-primary-600">support@nepdent.com</span>
              </p>
            </div>
          </div>
        </div>
